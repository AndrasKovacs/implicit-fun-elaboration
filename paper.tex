...
is important for defining more involved example programs\footnote{In presentations of dependent type theories without explicit substitutions, the $\slet$ rule is not
