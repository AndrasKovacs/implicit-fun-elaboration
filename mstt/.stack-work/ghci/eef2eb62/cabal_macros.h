...
/* package implicit-fun-elab-0.1.0.0 */
#ifndef VERSION_implicit_fun_elab
#define VERSION_implicit_fun_elab "0.1.0.0"
#endif /* VERSION_implicit_fun_elab */
#ifndef MIN_VERSION_implicit_fun_elab
#define MIN_VERSION_implicit_fun_elab(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_implicit_fun_elab */
...
#define CURRENT_COMPONENT_ID "implicit-fun-elab-0.1.0.0-IxGVpnEutHeG4iUhPqCIzF-implicit-fun-elab"
