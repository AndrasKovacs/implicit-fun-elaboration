...
/* package microlens-platform-0.4.0 */
#ifndef VERSION_microlens_platform
#define VERSION_microlens_platform "0.4.0"
...
#define CURRENT_COMPONENT_ID "implicit-fun-elab-0.1.0.0-D38P0XF5wFNCkUwnBqfxYx-implicit-fun-elab"
